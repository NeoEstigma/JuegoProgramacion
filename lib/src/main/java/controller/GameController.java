...
public class GameController {
    ...
    @FXML private Label lblDataPoints, lblDpSegundo, lblNivel, lblDpPorClick;

    @FXML private Label lblRaspberryValor, lblRaspberryPrecio, lblRaspberryEstado;
    @FXML private Label lblPcValor, lblPcPrecio, lblPcEstado;
    @FXML private Label lblJuniorValor, lblJuniorPrecio, lblJuniorEstado;
    @FXML private Label lblSeniorValor, lblSeniorPrecio, lblSeniorEstado;
    @FXML private Label lblCafeValor, lblCafePrecio, lblCafeEstado;
    @FXML private Label lblRgbsValor, lblRgbsPrecio, lblRgbsEstado;

    @FXML private Label lblProgresoActual, lblProgresoMaximo;

    @FXML private TextArea terminalArea;
    @FXML private ProgressBar nodoBarra;
    ...
    private final String[] nombresNiveles = {
        "Script Kiddie",
        "Escaner de Red",
