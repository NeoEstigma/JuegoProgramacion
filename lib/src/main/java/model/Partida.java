...
/**
 * Clase principal del modelo de Terminal Clicker.
 * Representa el estado completo de una partida en curso e implementa
 * toda la lógica del juego: acumulación de Data Points, compra de mejoras,
 * producción pasiva y avance de nivel.
 * Implementa el patrón Singleton para que el controlador pueda acceder
 * a la partida activa desde cualquier punto de la aplicación.
 *
 * @author Mateo
 */
...
public class Partida {
    ...
    private static final String[] NOMBRES_NIVELES = {
        "Script Kiddie", "Pen Tester", "Operador Encubierto",
	...
	public static Partida getInstancia() {
	 ...
	 /**
     * Crea una nueva partida con el nombre del jugador dado y la establece
     * como instancia activa del singleton.
     *
	...
	/**
     * Establece una partida existente como instancia activa del singleton.
     * Se usa al cargar una partida guardada desde MongoDB.
     *
     ...
     * Inicializa todos los valores de una partida nueva desde cero.
     */
	public Partida() {
		this.jugador = "";
		this.dp = 0;
     ...
     * Inicializa la partida desde cero y asigna el nombre del operador.
     *
	...
	public Partida(String jugador) {
	 ...
	 /**
     * Constructor completo para reconstruir una partida desde MongoDB.
     * Usado por {@link PartidaDao} al cargar una partida guardada.
     *
     * @param jugador       nombre del operador
	...
	/**
     * Recalcula los precios de todas las mejoras según las unidades compradas.
     * Se llama al cargar una partida guardada para restaurar los precios correctos,
     * ya que MongoDB solo almacena las cantidades, no los precios actuales.
     */
     ...
     *
     * @return mensaje para mostrar en el terminal, o null si la partida ha terminado
     */
	public String click() {
		if (terminado) {
			return null;
     ...
     * Aumenta los DP por clic en 1 y el precio un 5%.
     *
     ...
     * Aumenta los DP por clic en 5 y el precio un 6%.
     *
     * @return mensaje para mostrar en el terminal
     */
     ...
     * Aumenta la producción pasiva en 10 DP/s y el precio un 8%.
     *
     * @return mensaje para mostrar en el terminal
     */
     ...
     * Aumenta la producción pasiva en 50 DP/s y el precio un 10%.
     *
     * @return mensaje para mostrar en el terminal
     */
     ...
     * Aumenta la producción pasiva en un 10% del total actual y el precio un 35%.
     *
     * @return mensaje para mostrar en el terminal
     */
     ...
     * Aumenta la producción pasiva en un 50% del total actual y el precio un 50%.
     *
     * @return mensaje para mostrar en el terminal
     */
     ...
     *
     * @return "FIN" si se ha completado el juego, mensaje de avance de nivel,
     *         o mensaje indicando los DP necesarios si no hay suficientes.
     */
	...
	/**
     * Aumenta un precio aplicando un multiplicador.
     * Garantiza que el nuevo precio siempre sea mayor que el anterior.
     *
	...
	/**
     * Devuelve el nombre del nivel de acceso actual.
     * Corrige el valor de nivel si está fuera de rango.
     *
    ...
    public long getDp() { return dp; }
    /** @param dp Data Points a establecer */
    public void setDp(long dp) { this.dp = dp; }

    /** @return DP que se suman por cada clic */
    public long getDpPorClick() { return dpPorClick; }
    /** @param dpPorClick DP por clic a establecer */
    public void setDpPorClick(long dpPorClick) { this.dpPorClick = dpPorClick; }

    /** @return DP generados automáticamente por segundo */
    public long getDpSegundo() { return dpSegundo; }
    /** @param dpSegundo DP por segundo a establecer */
    public void setDpSegundo(long dpSegundo) { this.dpSegundo = dpSegundo; }
     ...
     * Usado por {@link PartidaDao} al reconstruir la partida desde MongoDB.
     *
